...
static uint32_t colors[][3]                = {
	/*               fg          bg          border    */
	[SchemeNorm] = { 0xb8bb26ff, 0x000000ff, 0x101010ff },
	[SchemeSel]  = { 0xb8bb26ff, 0x000000ff, 0xfe8019ff },
...
static const Rule rules[] = {
	...
	{ "foot",             NULL,       0,            0,          1,      0,         -1 }, /* make alacritty swallow clients that are not foot */
};
...
static const char *menucmd[] = { "wmenu-run", "-S", "fe8019", "-N", "000000", "-s", "000000", "-n", "b8bb26", NULL };
